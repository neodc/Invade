...
unsigned UnitType::hpMax() const {
	return hpMax_;
}
int UnitType::speed() const {
	return speed_;
}
int UnitType::accuracy() const {
	return accuracy_;
}
bool UnitType::elite() const {
	return elite_;
}
unsigned UnitType::bombshell() const {
	return bombshell_;
}
unsigned UnitType::id() const {
	return id_;
}
