...
bool ClientInvade::stable() const {
	return stable_;
}
const Invade & ClientInvade::model() const {
	return model_;
}
bool ClientInvade::requestedNewGame() const {
	return requestedNewGame_;
}

Side ClientInvade::side() const {
	return side_;
}
